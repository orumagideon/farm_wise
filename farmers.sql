...
--
-- Table structure for  `addagroproducts`
--
...
('test', 'test@gmail.com', 1, 'MAIZE', ' Tips for Growing Maize. Well drained black cotton soils are suitable.', 520),
('test', 'test@gmail.com', 2, 'TEA', ' Tips for Growing Tea. Acidic, well-drained soils with ample sunlight are ideal. ', 563):
('arkpro', 'arkpro@gmail.com', 3, 'SUGARCANE', 'Tips for Growing Sugarcane. Deep, fertile soils with good drainage and plenty of sunshine are essential.', 582);
